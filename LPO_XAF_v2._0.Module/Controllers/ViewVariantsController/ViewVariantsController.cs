//-----------------------------------------------------------------------
// <copyright file="F:\Users\dlandry\Source\Repos\LPO_V2\LPO_XAF_v2._0.Module\Controllers\ViewVariantsController\ViewVariantsController.cs" company="David W. Landry III">
...
using LPO_XAF_v2._0.Module.BusinessObjects._ViewVariantsManager;
using System;
using System.Collections.Generic;
using System.Linq;

namespace LPO_XAF_v2._0.Module.Controllers.ViewVariantsController
{
    ...
    public partial class ViewVariantsController : ViewController
    {
        ...
        private void SetDifferences(string xml, IModelView model)
        {
            ...
            differences.Add(string.Empty, xml);
        ...
        private void SaveViewVariantToXML(SettingsStore store)
        {
            ...
            View.SaveModel();
            isLayoutProcessed = false;
            store.Xml = UserDifferencesHelper.GetUserDifferences(View.Model)[string.Empty];
            ((IObjectSpaceLink)store).ObjectSpace.CommitChanges();
        }

        private void UpdateDefaultSettings(IModelView model)
        {
            defaultUserSettings = UserDifferencesHelper.GetUserDifferences(model)[string.Empty];
        }
